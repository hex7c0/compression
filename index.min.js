...
function compression(options) {
    ...
    return null === threshold && (threshold = 1024), function(req, res, next) {
        ...
        res.flush = function() {
            ...
            return !0 !== ended && (this._header || this._implicitHeader(), stream ? stream.write(new Buffer(chunk, encoding)) : _write.call(this, chunk, encoding));
        }, res.end = function(chunk, encoding) {
            return !0 !== ended && (this._header || (this.getHeader("Content-Length") || (length = chunkLength(chunk, encoding)), 
        ...
        return onHeaders(res, function() {
            ...
            if (shouldTransform(req, res)) {
                ...
                if ("identity" !== (res.getHeader("Content-Encoding") || "identity")) return nocompress("already encoded");
