...
function compression(options) {
    ...
    return null === threshold && (threshold = 1024), function(req, res, next) {
        ...
        return res.flush = function() {
            ...
            return !ended && (this._header || this._implicitHeader(), stream ? stream.write(new Buffer(chunk, encoding)) : _write.call(this, chunk, encoding));
        }, res.end = function(chunk, encoding) {
            return !ended && (this._header || (this.getHeader("Content-Length") || (length = chunkLength(chunk, encoding)), 
